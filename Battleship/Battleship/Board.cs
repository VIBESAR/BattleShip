...
{
    public partial class SETP : Form
    {
        ...
        public SETP(int dimension, int shipsCount, int shipsSize, string gameType)
        {
        ...
        void next()
        {
            if (gameType == "pvp")
            {
                ...
                {
                    SETP playerTwoBoard = new SETP(dimension, shipsCount, shipsSize, gameType);
        ...
        void turnComplete()
        {
            ...
            Intentos.Text = "Intentos: " + remainingShips.ToString();
        ...
        private void SetupBoard_Load(object sender, EventArgs e)
        {
